...
namespace DiYi.IoT.SDK.Internal
{
    ...
    {
        private readonly IoTOptions _capOptions;
        ...
        public ConsumerServiceSelector(IServiceProvider serviceProvider)
        {
            ...
            _capOptions = serviceProvider.GetService<IOptions<IoTOptions>>().Value;
            ...
            IServiceProvider provider)
        {
            ...
            var capSubscribeTypeInfo = typeof(IIoTSubscribe).GetTypeInfo();
